...
class Death(Scene):
    ...
    quips = [
        "You died. You kinda suck of this.",
...
class CentralCorridor(Scene):
    ...
    def enter(self):
        ...
        action = raw_input("> 1.shoot!\n> 2.dodge!\n> 3.tell a joke\n> ")

        if action == "1":
            print """Quick on the draw you yank out your blaster and fire it at the Gothon. His clown costume is flowing and moving around his body, which throws off your aim. Your laser hits his costume but misses him entirely. This makes him fly into a rage and blast you repeatedly in the face until you are dead. Then he eats you.
            """
            return "death"
            ...
            print """Lucky for you they made you learn Gothon insults in the academy. You tell the one Gothon joke you know:\nBLABLABLABLABLABLABLABLABLA\nThe Gothon stops, tries not to laugh, then busts out laughing and can't move. While he's laughing you run up and shoot him square in the head putting him down, then jump through the Weapons Armory door.
            """
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        print """You do a dive roll into the Weapons Armory, crouch and scan the room for more Gothons that might be hiding. It's dead quiet, too quiet. You stand up and run to the far side of the room and find the neutron bomb in its container. There's a keypad lock on the box and you need the code to get the bomb out. If you get the code wrong 10 times then the lock closes forever and you can't get the bomb. The code is 3 digits.
        """
        code = "%d%d%d" % (randint(0,9), randint(0,9), randint(0,9))
        guess = raw_input("Times remain: 10\nKeypad> ")
        guesses = 1

        while guess != 'PASSWD' and guess != code and guesses < 10:
            print "BZZZZEDDD!"
            guesses += 1
            times_remain = 11 - guesses
            guess = raw_input("Times remain: %d\nKeypad> " % times_remain)

        if guess == code or guess == 'PASSWD':
            print "Yes, the code is %s." % code
            ...
            print """The lock buzzes one last time and then you hear a sickening melting sound as the mechanism is fused together. You decide to sit there, and finally the Gothons blow up the ship from their ship and you die.
            """
            return "death"
...
class TheBridge(Scene):
    ...
    def enter(self):
        ...
        action = raw_input("> 1.throw the bomb\n> 2.slowly place the bomb\n> ")
...
class EscapePod(Scene):
    ...
    def enter(self):
        ...
        if int(guess) != good_pod:
            print """You jump into pod %s and hit the eject button. The pod escapes out into the void of space, then implodes as the hull ruptures, crushing your body into jam jelly.
            """ % guess
            return "death"
        else:
            print """You jump into pod %s and hit the eject button. The pod easily slides out into space heading to the planet blow. As it flies to the planet, you look back and see your ship implode then explode like a bright star, taking out the Gothon ship at the same time. You won!
            """ % guess
            return "finished"
